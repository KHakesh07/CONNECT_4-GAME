...
print('\033[36m')
print(f"ARE YOU READY PLAYER {name1}")
time.sleep(4)
os.system('clear')
print("YOUR GAME STARTS WITH IN 3 SECONDS AND YOUR SYMBOL IS 😱")
time.sleep(2)
os.system('clear')
print("3")
time.sleep(1)
...
def checkForWinner(chip):
  ...
  for y in range(rows):
    for x in range(cols - 3):
      if gameBoard[x][y] == chip and gameBoard[x + 1][y] == chip and gameBoard[
          x + 2][y] == chip and gameBoard[x + 3][y] == chip:
  ...
  for x in range(rows):
    for y in range(cols - 3):
      if gameBoard[x][y] == chip and gameBoard[x][y + 1] == chip and gameBoard[
          x][y + 2] == chip and gameBoard[x][y + 3] == chip:
        print("\nGame over", chip, "wins! Thank you for playing :)")
        return True
  ...
  for x in range(rows - 3):
    for y in range(3, cols):
      if gameBoard[x][y] == chip and gameBoard[x + 1][
          y - 1] == chip and gameBoard[x + 2][y - 2] == chip and gameBoard[
              x + 3][y - 3] == chip:
        print("\nGame over", chip, "wins! Thank you for playing :)")
        return True
